...
\begin{quote}
\verbatiminput{code/02_ifelse.m}
\end{quote}
...
\begin{quote}
\verbatiminput{code/02_switch.m}
\end{quote}
...
\begin{quote}
\verbatiminput{code/02_vectorization.m}
\end{quote}
